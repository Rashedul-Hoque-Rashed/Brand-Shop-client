            ...
            <div className="navbar container mx-auto px-2 md:px-6 py-4">
                <div className="navbar-start">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-xl md:text-2xl font-bold font-serif text-stone-700 dark:text-stone-200">Glamour</p>
                    </div>
                </div>
                ...
                <div className="navbar-end gap-2 md:gap-4">
                    ...
                    <label className="swap swap-rotate">
                        ...
                        <input onClick={toggleTheme} onChange={handelToggle} type="checkbox" />
                    ...
                    <Link to="/login" className="btn font-sans normal-case px-4 md:px-6 text-white bg-pink-500 hover:bg-pink-600">Login</Link>
