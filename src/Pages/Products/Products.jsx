                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-16">
                        {
                            products.map(product => <div key={product._id}>
                                <div className="flex flex-col lg:flex-row gap-6 lg:items-center shadow-lg rounded-lg p-4">
                                    ...
                                    <img className="flex-1 w-full lg:w-72 h-60 rounded-t-lg lg:rounded-l-lg mx-auto" src={product.photo} alt="" />
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex font-sans items-center gap-2">
                                            <Link to="/details" className="btn font-sans normal-case px-4 md:px-6 text-white bg-pink-500 hover:bg-pink-600 font-sans">Details</Link>
                                            <Link to="/update" className="btn font-sans normal-case px-4 md:px-6 text-white bg-blue-500 hover:bg-blue-600 font-sans">Update</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>)
